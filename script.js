...
const places = [
  ...
  { name: '杭州 · 西湖', latitude: 30.2444, longitude: 120.1499, date: '2023 年 11 月 3 日', image: 'assets/image-placeholder.svg', story: '沿着西湖慢慢散步，看夕阳落在湖面上，桂花香气让秋天变得格外具体。', tips: '建议从断桥附近出发，避开周末午后高峰，步行或骑行都很舒服。' },
  { name: '成都 · 宽窄巷子', latitude: 30.6711, longitude: 104.0556, date: '2022 年 9 月 12 日', image: 'assets/image-placeholder.svg', story: '在青砖灰瓦之间喝了一杯盖碗茶，感受成都悠闲又热闹的日常。', tips: '下午到晚上氛围最好，可以把宽巷子、窄巷子和井巷子一起逛完。' }
];
